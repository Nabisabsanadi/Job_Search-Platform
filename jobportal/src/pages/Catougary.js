                    ...
                    <div className="row g-4">
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-mail-bulk text-info mb-4"></i>
                                <h6 className="mb-3">Marketing</h6>
                                <p className="mb-0 text-info">123 Vacancy</p>
                            </Link>
                        </div>
                        ...
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-tasks text-info mb-4"></i>
                        ...
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-chart-line text-info mb-4"></i>
                        ...
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-hands-helping text-info mb-4"></i>
                        ...
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-book-reader text-info mb-4"></i>
                        ...
                        <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                            <Link className="cat-item rounded p-4" to="">
                                <i className="fa fa-3x fa-drafting-compass text-info mb-4"></i>
